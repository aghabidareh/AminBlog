          ...
          <div class="card-body">
            ...
            <form class="row g-3" action="{{ route('update-category') }}" method="POST">
              ...
              <div class="col-12">
                ...
                <input type="text" name="name" value="{{ $categoty->name }}" required class="form-control" id="inputNanme4">
              </div>
              <div class="text-danger">{{ $errors->first('name') }}</div>

              <div class="col-12">
                <label class="form-label">Title</label>
                <input type="text" name="title" value="{{ $categoty->title }}" required class="form-control">
              </div>
              ...
              <div class="col-12">
                ...
                <input type="text" name="meta_title" value="{{ $categoty->meta_title }}" required class="form-control">
              </div>
              <div class="text-danger">{{ $errors->first('meta_title') }}</div>

              <div class="col-12">
                <label class="form-label">Meta Keywords</label>
                <input type="text" name="meta_keywords" value="{{ $categoty->meta_keywords }}" required class="form-control">
              </div>
              <div class="text-danger">{{ $errors->first('meta_keywords') }}</div>

              <div class="col-12">
                <label class="form-label">Meta Description</label>
                <textarea name="meta_description" id="form-control">{{ $categoty->meta_description }}</textarea>
              </div>
